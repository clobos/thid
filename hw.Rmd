...
b. The above equations assume *frequency-dependent transmission*, i.e., $\lambda=\beta\,\frac{Y}{N}$.
...
c. Compare the resulting equations with those you derived in part a.
  Discuss.
